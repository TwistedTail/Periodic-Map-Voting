			...
			lua\
				...
				AddonFolder\
					core\		<--- FILES in this directory are loaded FIRST
						example_sv.lua
					firstFolder\	  <--- ALL other DIRECTORIES are loaded AFTER in ALPHABETICAL ORDER
						exampleFolder_cl\
							thisFileIsSentToClients.lua
					secondFolder\  <--- All directories under AddonFolder have a table created for them, eg. AddonGlobal.SecondFolder
]]--

local AddonFolder = "PMV" -- This is the name of the folder that gets loaded eg. addons\AddonFolder\lua\AddonFolder\
local AddonGlobal = "PMV" -- This is the name of the global table for the addon (_G.AddonGlobal)
